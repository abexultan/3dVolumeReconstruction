...
//     plywriter.write<pcl::PointXYZRGBNormal> (btfilename+std::to_string(count) +".ply", *cloud_cluster, false); //*
//     // j++;
//   // }
...
void callback(sensor_msgs::PointCloud2ConstPtr const& pcloud2)
{
    printf("--------------------------------------------\n");
    ...
    // pcl::PointCloud<pcl::PointXYZRGBNormal> cloud2norm;
    //  // cloud2norm, cloud3norm, cloud4norm;
